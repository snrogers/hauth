...
spec = do
  describe "mkEmail" $ do
    describe "should pass" $
      mkEmailSpec "fart@barf.com" True
  ...
  describe "mkPassword" $ do
    ...
    describe "should fail" $ do
      mkPasswordSpec "aA1" ["Should be between 5 and 50"]
      mkPasswordSpec (fromString . take 51 . join $ repeat "aA1") ["Should be between 5 and 50"]
